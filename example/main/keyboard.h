    ...
    class Keyboard
    {
        public:
            enum KeyCode {
                ...
                KEY_RIGHTBRACE = 0x30, KEY_BACKSLASH = 0x31, KEY_HASHTILDE = 0x32,
                ...
                KEY_PRTSC = 0x46, KEY_SCROLLLOCK = 0x47, KEY_PAUSE = 0x48, KEY_INSERT = 0x49,
                KEY_HOME = 0x4a, KEY_PAGEUP = 0x4b, KEY_DELETE = 0xD4, KEY_END = 0x4d,
                KEY_PAGEDOWN = 0x4e, KEY_RIGHT = 0x4f, KEY_LEFT = 0x50, KEY_DOWN = 0x51,
                KEY_UP = 0x52,
                ...
                KEY_KPDOT = 0x63, KEY_KPLEFTPAREN = 0xb6, KEY_KPRIGHTPAREN = 0xb7,
                ...
                KEY_MEDIA_NEXTSONG = 0xeb, KEY_MEDIA_EJECTCD = 0xec, KEY_MEDIA_VOLUMEUP = 0xed,
                KEY_MEDIA_VOLUMEDOWN = 0xee, KEY_MEDIA_MUTE = 0xef, KEY_MEDIA_WWW = 0xf0,
                KEY_MEDIA_BACK = 0xf1, KEY_MEDIA_FORWARD = 0xf2, KEY_MEDIA_STOP = 0xf3,
                KEY_MEDIA_FIND = 0xf4, KEY_MEDIA_SCROLLUP = 0xf5, KEY_MEDIA_SCROLLDOWN = 0xf6,
                KEY_MEDIA_EDIT = 0xf7, KEY_MEDIA_SLEEP = 0xf8, KEY_MEDIA_COFFEE = 0xf9,
                KEY_MEDIA_REFRESH = 0xfa, KEY_MEDIA_CALC = 0xfb
            };
